...
export const chapter3Level2: LevelConfig = {
  ...
  hintText: '前行的路上，总有忠诚的影子相随',
  hintTextEn: 'On the road ahead, faithful shadows walk beside you',
  transitHintText: '继续铺路，带着忠诚的伙伴向前',
  transitHintTextEn: 'Keep paving the way — bring your loyal companion along',
  walkerSheet: {
